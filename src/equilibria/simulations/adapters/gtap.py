"""GTAP simulation adapter (state-based placeholder until native solver integration)."""
...
class GTAPAdapter(ParameterStateAdapter):
    """GTAP adapter using generic state-scenario mechanics."""
