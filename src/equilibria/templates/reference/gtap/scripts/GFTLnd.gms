* -------------------------------------------------------------------------
*
*  Global free trade -- with upward sloping supply curves for land
*                       Elasticity overrides are around line 97
*
...
* >>>>> OVERRIDE LAND SUPPLY ELASTICITIES <<<<<

parameter etaf0(r,fp) "Aggregate factor supply elasticities" /
...
MENA          .Land   0.0
SSA           .Land   1.2
RestofWorld   .Land   0.6

/ ;

etaf(r,fp) = etaf0(r,fp) ;
