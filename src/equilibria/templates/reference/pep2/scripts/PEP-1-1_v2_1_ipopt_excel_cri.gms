...
- ExcelReader:
    file: %VAL_PAR_XLS%
    symbols:
      - { name: PARJ,  rowDimension: 1, columnDimension: 1, range: PAR!A5:E10 }
      - { name: PARI,  rowDimension: 1, columnDimension: 1, range: PAR!A13:C18 }
      - { name: PARJI, rowDimension: 1, columnDimension: 1, range: PAR!A21:F26 }
      - { name: PARAG, rowDimension: 1, columnDimension: 1, range: PAR!A29:F41 }
- GDXWriter:
    file: %VAL_PAR_GDX%
    symbols: [ {name: PARJ}, {name: PARI}, {name: PARJI}, {name: PARAG} ]
$offEmbeddedCode
$label LOAD_VALPAR_GDX
$GDXIN %VAL_PAR_GDX%
