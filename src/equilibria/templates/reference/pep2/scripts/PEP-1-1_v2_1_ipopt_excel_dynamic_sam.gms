...
$if not set SAM_XLS $setglobal SAM_XLS ../data/SAM-V2_0_connect.xlsx
...
$if not set SAM_XLS $setglobal SAM_XLS ../data/SAM-V2_0_connect.xlsx
$if not set SAM_GDX $setglobal SAM_GDX ../data/SAM-V2_0_from_excel.gdx
...
- ExcelReader:
    file: %VAL_PAR_XLS%
    symbols:
      - { name: PARJ,  range: PAR!A5:E9,  rowDimension: 1, columnDimension: 1 }
      - { name: PARI,  range: PAR!A12:C17, rowDimension: 1, columnDimension: 1 }
      - { name: PARJI, range: PAR!A20:F24, rowDimension: 1, columnDimension: 1 }
      - { name: PARAG, range: PAR!A27:F37, rowDimension: 1, columnDimension: 1 }
- GDXWriter:
    file: %VAL_PAR_GDX%
