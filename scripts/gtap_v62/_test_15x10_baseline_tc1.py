"""Try to push gtap6_15x10 baseline to PATH term_code=1.

With bake_tolerance=1e-6 we already get r=2e-5 in 11 majors. Relax
convergence_tolerance to 1e-4 (still tight enough for shock-grade
warm-start) and see if tc=1 is reached.
"""
import os, sys, time
...
print("\n=== gtap6_15x10 baseline: bake_tol=1e-6, conv_tol=1e-4 ===", flush=True)
sets = GTAPv62Sets()
