...
ROWS: list[Row] = [
    ...
    # SHOCK measured @ tol1% (2026-06-30). ifSUB=1 import-wedge fix lifted 55→76%;
    # a remaining export-side link (xw[USA,*,EU_28]) caps it below ifSUB=0.
    Row("gtap7_3x3", "gtap_solve", 0, ("base", "check", "shock"), 99.0, "99.70% (CHECK 100%)", "local", "out_gtap_shock_ifsub0.gdx"),
    Row("gtap7_3x3", "gtap_solve", 1, ("base", "check", "shock"), 70.0, "75.90% (CHECK 100%; export link open)", "local", "out_gtap_shock_ifsub1.gdx"),
]
