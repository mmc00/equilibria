...
out = {
    'residual': r['residual'],
    'usa': {
        'yc': float(pyo_value(m.yc['USA', _t])),
        'yg': float(pyo_value(m.yg['USA', _t])),
        'rsav': float(pyo_value(m.rsav['USA', _t])),
        'regy': float(pyo_value(m.regy['USA', _t])),
        'facty': float(pyo_value(m.facty['USA', _t])),
        'ytax_ind': float(pyo_value(m.ytax_ind['USA', _t])),
