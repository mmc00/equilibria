...
# GAMS reference deltas (×1e6, from COMP.gdx generated by tariff_sim.gms,
# rate-scaled 10% imptx shock; values = (shock - base) * 1e6).
GAMS_REF = {
    "regy": {
        "Oceania": +1_119, "EastAsia": -20_101, "SEAsia": +470,
        "SouthAsia": +4_217, "NAmerica": +9_546, "LatinAmer": +11_385,
        "EU_28": +6_605, "MENA": +8_284, "SSA": +5_425, "RestofWorld": +5_970,
    },
    "gdpmp": {
        "Oceania": +1_442, "EastAsia": -21_378, "SEAsia": +784,
        "SouthAsia": +4_868, "NAmerica": +11_054, "LatinAmer": +13_451,
        "EU_28": +7_721, "MENA": +9_331, "SSA": +5_963, "RestofWorld": +6_843,
    },
    "pabs": {
        "Oceania": +984, "EastAsia": -799, "SEAsia": +509,
        "SouthAsia": +2_456, "NAmerica": +619, "LatinAmer": +2_749,
        "EU_28": +548, "MENA": +2_531, "SSA": +4_177, "RestofWorld": +2_045,
    },
}
